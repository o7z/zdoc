...
<div class="layout">
	<header>
		...
		<div class="header-actions">
			...
			{/if}
			{#if data.specKitEnabled}
				<a class="icon-btn" href={data.mode === 'spec-kit' ? '/' : '/sk/index.md'} aria-label="Switch docs mode" title={data.mode === 'spec-kit' ? '切换到 zdoc 文档' : '切换到 Spec Kit 文档'}>
